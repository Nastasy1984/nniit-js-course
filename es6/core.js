...
class Dictionary {
    ...
    addWord(wordEng, wordRus){
        ...
        if (!this.engToRus.has(wordEng)){
            ...
            console.log("The word " + worEng + " was added");
        }
        else {
            console.log("The word " + worEng + " was found in the dictionary");
        }
    }
    ...
    changeTranslation(wordEng, wordRus){
        ...
        if (this.engToRus.delete(wordEng)){
            this.engToRus.set(wordEng, wordRus);
            console.log("The translation of the word " + worEng + " was changed");
        }
        else{
            this.engToRus.set(wordEng, wordRus);
            console.log("The word " + worEng + " was added");
    ...
    deleteWord(wordEng){
        ...
        if (this.engToRus.delete(wordEng)){
            console.log("The word " + worEng + " was deleted");
        };
    }
